...
-----------------------------------------------------------------------------------------------------------------
                    Machine Learning Roadmap 2022 by CampusX


Learning Style behind This RoadMap: 

1. Linear: 
this roadmap is not parallel. it is linear. means ek topic khatam hone ke baad hi aap doosra topic start kar sakte ho.


2. Spoonfeed: 
Assuming you as a beginner. and as a Teenage boy. Har topic aur uska Resource mai aapko bataunga.


3. Spiral Learning: 
Humlog point A se point B multiple times jaenge. Poora ka poora cheej multiple times iterate karenge.
