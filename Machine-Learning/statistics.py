Location:  code--->git--->Machine-Learning---------->Statistics
...
if the result would have negative, then the variables would have negatively related.
...
Probability Density Functions (PDFs): It tells us the density of the varable on a perticular range. isse hum pata laga sakte hai. kaun sa variable best rahega do species ko distinguish karne ke liye. 
It is used to define the random variable’s probability coming within a distinct range of values.
